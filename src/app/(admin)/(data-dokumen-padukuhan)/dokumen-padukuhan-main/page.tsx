export default function DokumenPadukuhanMainPage() {
  return (
    <div className="mt-12 ml-3">
      {/* Header Section */}
      <div className="flex mb-3">
        <h1 className="font-bold text-3xl">Data Dokumen Padukuhan</h1>
      </div>
      ...
      <div className="overflow-hidden rounded-lg border border-gray-300 shadow-sm overflow-x-auto">
        <table className="min-w-full table-fixed border-collapse">
          <colgroup>
            <col className="w-16" /><col className="w-48" /><col className="w-96" /><col className="w-32" /><col className="w-40" />
          </colgroup>
          <thead>
            <tr className="bg-gray-300">
              <th className="border border-gray-400 px-4 py-3 text-center font-semibold">No.</th>
              <th className="border border-gray-400 px-4 py-3 text-left font-semibold">Nama Dokumen</th>
              <th className="border border-gray-400 px-4 py-3 text-left font-semibold">Deskripsi</th>
              <th className="border border-gray-400 px-4 py-3 text-left font-semibold">Tanggal Upload</th>
          ...
          <tbody>
            <tr className="hover:bg-gray-200 transition-colors duration-200">
              ...
              <td className="border border-gray-400 px-4 py-3 break-words">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Molestiae aspernatur nam cupiditate, ipsa, quo odio necessitatibus voluptatibus vitae laudantium nisi quibusdam, temporibus delectus. Ea doloribus, cum quos temporibus suscipit distinctio.
              </td>
